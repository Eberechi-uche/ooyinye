...
const fallback = `    What Is Meant By Lorem Ipsum In Website? The word Lorem Ipsum is
...
type BlogParserProps = {
  content: string;
};
const BlogParser: React.FC<BlogParserProps> = ({ content }) => {
  return (
    <>
      <Flex flexDir={"column"} my={"10"}>
        <div dangerouslySetInnerHTML={{ __html: content }} className="view" />
      </Flex>
    </>
  );
};
